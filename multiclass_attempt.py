...
# This is an offshoot of our previous architecture that's built for multiclass
# segmentation.
...
TRAIN_DATASET_PATH = r"C:\Users\sparq\Videos\EngsciMisc\APS360\Project\BraTS\BraTS2020_TrainingData\MICCAI_BraTS2020_TrainingData"
...
def train():
    ...
    # get the data
    train_dataloader, test_dataloader = dataprocessing.generate_dataloaders(TRAIN_DATASET_PATH, batch_size=1, flip=True, norm=True, stack=True)
    ...
    # DICE Training Curve
    axs[0].set_title("DICE Training Curve")
    axs[0].plot(range(1, epochs + 1), DICE_train_loss, label="Train")
    axs[0].plot(range(1, epochs + 1), DICE_val_loss, label="Validation")
    axs[0].legend(loc='best')
    axs[0].set_xlabel("Epochs")
    axs[0].set_ylabel("DICE")

    # BCE Training Curve
    axs[1].set_title("BCE Training Curve")
    axs[1].plot(range(1, epochs + 1), BCE_train_loss, label="Train")
    axs[1].plot(range(1, epochs + 1), BCE_val_loss, label="Validation")
    axs[1].legend(loc='best')
    axs[1].set_xlabel("Epochs")
    axs[1].set_ylabel("BCE")

    # DICE & BCE Training Curve
    axs[2].set_title("DICE & BCE Training Curve")
    axs[2].plot(range(1, epochs + 1), combined_train_loss, label="Train")
    axs[2].plot(range(1, epochs + 1), combined_val_loss, label="Validation")
    axs[2].legend(loc='best')
    axs[2].set_xlabel("Epochs")
    axs[2].set_ylabel("Combined DICE and BCE")
    ...
    save_model_path = "multiclass_test_model_0.pth"
